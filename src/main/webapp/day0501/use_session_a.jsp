...
<input type="submit" name="입력" class="btn btn-success" id="btn"/>
</form>

</c:when>
<c:otherwise>
<c:out value="${sessionScope.name }"/>님 로그인 하셨습니다.
<a href="use_session.d.jsp">로그아웃</a>
</c:otherwise>
</c:choose> 
