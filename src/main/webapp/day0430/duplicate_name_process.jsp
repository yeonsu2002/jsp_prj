<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    info="name속성이 중복되는 form control의 값 입력받는 일"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<div id="container">
<%
//POST 방식일떄 한글 깨짐을 처리하기 위해 입력되는 문자열의 charset을 encoding
...
//<input type="radio" 는 여러 개 중 하나만 선택 가능 하다. 하나만 parameter로 넘어온다.
String gender=request.getParameter("gender");


//<input type="checkbox"는 여러개 가 선택가능하고, 같은 이름으로 여러개의 값이
//입력된다. => 여러개의 값을 저장할 수 있게 배열로 받는다. 

String[] lang=request.getParameterValues("lang");

//<input type="text"일지라도 name이 같으면 배열로 처리.
